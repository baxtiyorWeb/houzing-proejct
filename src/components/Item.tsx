    ...
    <div className="bg-white mx-3 py-2   relative ">
      <div className="hover:scale-y-105 hover:shadow-lg transition-all duration-150 rounded-md overflow-hidden" >
        ...
        <div className="mb-2 px-[20px] border border-[#E6E9EC]">
          <h1 className=" mt-6 font-semibold text-base leading-6 tracking-[0%]">New Apartment Nice Wiew</h1>
          ...
          <div className="mb-2">
            <p className="text-[#696969] font-normal text-xs leading-5 tracking-[0%] line-through">$2,800/mo</p>
            <span className="text-[#0D263B] font-semibold text-base leading-6 tracking-[0%]">$7,500/mo</span>
          </div>
        </div>
      </div >
      <div>
